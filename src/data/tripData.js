...
export const DAYS = [
  ...
  },
  {
    ...
    travel: null,
    lodging: null,
    coords: [50.0593, 7.7686], // Bacharach
    notes: '',
    activities: [
      {
        id: 'day-07-rheinfels-bacharach',
        name: 'St. Goar, Bacharach & the Rhine',
        icon: 'castle',
        category: 'Tour',
        cost: null,
        summary: 'A car-free day south along the Rhine -- self-guided ruins at Burg Rheinfels, wine tasting and a walking tour in Bacharach, then a scenic downstream KD cruise back to Boppard for dinner.',
        startingPoint: 'Rheinufer 8, Spay, Rhineland-Palatinate, 56322 Germany -- a short walk to Spay Bahnhof for the 8:30 AM train.',
        startDirectionsUrl: 'https://www.google.com/maps/search/?api=1&query=50.2699%2C7.6119',
        directionsUrl: 'https://www.google.com/maps/dir/?api=1&origin=50.2699,7.6119&destination=50.2329,7.5865&waypoints=50.1546,7.7044%7C50.0593,7.7686%7C50.2329,7.5899&travelmode=walking',
        websiteUrl: 'https://www.k-d.com/en/',
        websiteLabel: 'KD Rhine cruise schedules',
        events: [
          { time: '8:30 AM', title: 'Spay Bf → St. Goar', description: 'MittelrheinBahn (RB), ~20 min via Boppard.' },
          { time: '9:00 AM', title: 'St. Goar → Burg Rheinfels', description: 'Walk 15-25 min via the signed trail, or catch shuttle bus #699.' },
          { time: '9:30-11:30 AM', title: 'Burg Rheinfels', description: 'Self-guided -- no tour required. Ruins, tunnels, battlements. ~$6/adult, pay on-site.' },
          { time: '11:30 AM', title: 'Back down to St. Goar station', description: 'Walk or shuttle back down.' },
          { time: '11:50 AM', title: 'St. Goar → Bacharach', description: 'Regional train, ~20-25 min via Oberwesel.' },
          { time: '12:15 PM', title: 'Arrive Bacharach', description: '' },
          { time: '12:30-2:00 PM', title: 'Wine tasting & lunch: Weingut Karl Heidrich', description: '' },
          { time: '2:00-3:15 PM', title: 'Self-guided Altstadt walk', description: 'Town walls, towers, Wernerkapelle ruins, market square.' },
          { time: '3:15 PM', title: 'Bacharach KD dock → Boppard', description: 'Downstream KD Rhine cruise, ~1.5-2 hrs. Confirm the exact departure on k-d.com closer to the date -- recent schedules show sailings around 12:15/15:15/17:15.' },
          { time: '~5:00 PM', title: 'Arrive Boppard', description: '' },
          { time: '5:00-7:00 PM', title: 'Dinner in Boppard: DIVERSO', description: 'Mediterranean, Rheinallee 47a -- right at the KD landing stage, riverfront seating.' },
          { time: '7:00 PM', title: 'Boppard → Spay', description: 'Short train (~5 min) or taxi back to the house.' },
        ],
        tips: [
          'Rheinland-Pfalz-Ticket x2 (split 5+3 for the group of 8) covers all train legs -- about $130 total for the day.',
          "KD cruise isn't covered by the rail ticket, but showing it at the KD kiosk typically gets a 20% fare discount.",
          'Burg Rheinfels: no advance tickets needed, pay on-site.',
        ],
      },
    ],
  },
