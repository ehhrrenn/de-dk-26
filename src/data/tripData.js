...
export const DAYS = [
  {
    ...
    activities: [
      ...
      },
      {
        ...
        category: 'Travel',
        cost: null,
        summary: 'From Munich Airport (MUC) to the Munich stay (TBD -- new place to be booked; the original Airbnb was cancelled by the host).',
        startingPoint: 'Munich Airport (MUC), Terminal 1',
        events: [
          { time: '~3:00 PM (Sep 18)', title: 'Head toward the Munich stay (TBD)', description: 'From MUC (Terminal 1) -- location and check-in time to be confirmed once a new place is booked.' },
        ],
        tips: [],
      },
    ],
  },
  {
    ...
    travel: null,
    lodging: {
      name: 'TBD -- new stay to be booked',
      provider: null,
      address: null,
      link: null,
      cost: null,
    ...
    activities: [
      {
        ...
        startingPoint: 'Your Munich stay (TBD -- new location pending)',
