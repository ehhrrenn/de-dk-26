...
export const DAYS = [
  ...
  },
  {
    ...
    travel: null,
    lodging: null,
    coords: [50.2056, 7.3367], // Burg Eltz
    notes: '',
    activities: [
      {
        id: 'day-08-burg-eltz',
        name: 'Burg Eltz Castle + Hike to Moselkern',
        icon: 'castle',
        category: 'Tour',
        cost: null,
        summary: "A morning taxi into the Mosel Valley for a guided tour of Burg Eltz -- a fairy-tale castle still owned by the same family after 34 generations -- then a forest hike down the Elzbach stream to Moselkern and a train home via Koblenz. Details from Rick Steves Germany, pp. 546-548.",
        startingPoint: 'Rheinufer 8, Spay, Rhineland-Palatinate, 56322 Germany -- taxi pickup at the house. The taxi can only go as far as the Burg Eltz castle parking lot (Wierschem side).',
        startDirectionsUrl: 'https://www.google.com/maps/dir/?api=1&origin=Rheinufer%208%2C%2056322%20Spay%2C%20Germany&destination=Burg%20Eltz%20Parkplatz%2C%20Wierschem%2C%20Germany&travelmode=driving',
        startDirectionsLabel: 'Taxi route to Burg Eltz',
        directionsUrl: 'https://www.google.com/maps/dir/?api=1&origin=Burg%20Eltz%2C%20Wierschem%2C%20Germany&destination=Bahnhof%20Moselkern%2C%20Moselkern%2C%20Germany&travelmode=walking',
        linkLabel: 'Hike: Burg Eltz → Moselkern station',
        events: [
          { time: '9:00 AM', title: 'Taxi pickup at the house', description: 'Rheinufer 8, Spay. Pre-booked taxi to the Burg Eltz castle parking lot (~45-60 min drive via Koblenz and the Mosel). For a group of 8, book a van (Großraumtaxi) or two cars.' },
          { time: '~10:00 AM', title: 'Arrive Burg Eltz parking lot', description: "From the lot, a well-signed, gently downhill trail reaches the castle gate in ~15 min. Or take the shuttle bus: €2, pay cash onboard, departs about every 10 min from the far end of the parking lot." },
          { time: '~10:15 AM', title: 'Buy tickets + pick up the English description', description: "€14/person -- includes the mandatory guided tour and the treasury. Open Apr-Oct daily from 9:30, last tour 17:30. Grab the free English description at the entry, then head up to the innermost courtyard for the next English tour (you'll rarely wait more than 30 min)." },
          { time: '~10:30 AM', title: 'Burg Eltz -- English Guided Tour (40 min)', description: "The only way to see the castle. Start in the Rübenach House (from 1472): armory with medieval weaponry, lower hall with a giant table, tapestries, a mermaid-carved antler chandelier, and a priceless Lucas Cranach the Elder painting. Upstairs is the painted bedroom -- look for the jousting relief on the canopy, the lusty green decorations, the cabinet-enclosed 'rain drain' toilet, and the bay-window chapel. Then the Rodendorf House: the Prince-Electors' Room of family portraits (spot the shared family feature -- it's on the nose), the Great Hall shared by all three families (carved jester = 'fool's freedom', rose = 'rose of silence'), portraits of children with adult heads, a vaulted former chapel with a tiled stove, and the kitchen with food hung from the ceiling to keep it from rodents. Finish in the courtyard." },
          { time: '~11:15 AM', title: 'Treasury', description: 'Included in the ticket. Entrance is in the corridor between the central courtyard and the outer café terrace -- ask for the English flier. Four higgledy-piggledy cellar floors of precious, eccentric, and historic family mementos: swords, crossbows, and elaborate jewelry. Also a good fill-in if you have a wait before the tour.' },
          { time: '~12:00 PM', title: 'Lunch at the castle café (or picnic)', description: 'The modest castle café, up from the ticket booth, serves soups and bratwurst-and-fries and can have long lines. Consider bringing a picnic or at least snacks -- there is nothing else until Moselkern.' },
          { time: '1:00 PM', title: 'Hike down to Moselkern', description: "~75 min at a steady clip; allow an extra 20 min to enjoy the scenery. Rick Steves: a 'magical pine forest.' Start from the castle down the steep flight of stairs, then follow the Elzbach stream downstream on the dirt trail through the forest (~45 min) until it turns paved at the Hotel Ringelsteiner Mühle parking lot. Continue down the road along the stream through a residential neighborhood (the footpath and bridge options rejoin), go through the underpass, and turn left onto narrow Oberstrasse past the village church, straight across Weinbergsstrasse to Moselkern station (~30 min from the hotel). Less than 400 ft of elevation change." },
          { time: '~2:30 PM', title: 'Train: Moselkern → Koblenz Hbf', description: 'Hourly regional train along the Mosel (~30-35 min). Confirm exact times on bahn.com nearer the date.' },
          { time: '~3:10 PM', title: 'Train: Koblenz Hbf → Spay', description: 'Transfer at Koblenz Hbf to the RB26 toward Mainz; ~15 min to Spay. Confirm exact times on bahn.com.' },
          { time: '~3:45 PM', title: 'Back at the house', description: 'Spay station to Rheinufer 8 is a short walk.' },
        ],
        tips: [
          'Pre-book the 9:00 AM taxi the day before. Rick Steves lists Cochem taxi +49 2671 8080 and Moselkern taxi +49 2672 1407 -- those are Mosel-side companies, so for a Spay pickup a Boppard/Koblenz taxi is likely easier. Ask for a van for 8 people.',
          'Burg Eltz: €14 includes the mandatory guided tour and the treasury. Open April-October daily from 9:30, last tour departs 17:30; closed Nov-March. Info: +49 2672 950 500, burg-eltz.de.',
          "Tours are 40 min and guide-only. After buying tickets, go to the innermost courtyard for the next English tour; you'll rarely wait more than 30 min -- dip into the treasury if you have a wait.",
          'Wear real shoes for the hike: the trail is mostly gentle but has a few uneven parts that are slippery when wet, plus the steep flight of stairs right by the castle.',
          'Bring cash (shuttle bus is cash-only) and snacks/water -- the castle café is the only food between the parking lot and Moselkern.',
          "Background: the first record of the castle dates to 1157, and by about 1490 it looked as it does today. It's three separate tall, skinny homes of three branches of one family around a tiny courtyard. The tour enters two; the third is still the castellan's residence and where the Eltz family stays. Johann Jakob von und zu Eltz (34th generation) has run it since 2018 -- look for the family photo on the tour.",
          'Look for the fresh flowers -- a tradition started by the last Countess of Eltz, who arranged them weekly for 40 years; a local florist continues it today.',
          'Fallback if it rains hard: take the €2 shuttle back up to the parking lot and taxi to Moselkern station (Moselkern taxi ~€24, 20 min per Rick Steves) instead of hiking.',
          'Free evening: Weingut Weingart (less than 1 km from the house) is open Thu until 6:30pm if the group still wants a tasting -- call ahead for 8: +49 2628 8735.',
        ],
      },
    ],
  },
