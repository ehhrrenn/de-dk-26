  ...
  },
  {
    ...
    activities: [
      ...
      },
      {
        ...
        startDirectionsUrl: 'https://www.google.com/maps/dir/?api=1&origin=48.1226192,11.5458491&destination=48.1374,11.5755&travelmode=transit',
        ...
        events: [
          ...
          { time: '9:00 AM', title: 'Marienplatz', description: "Munich's central square since 1158, marked by the Mariensäule (Mary's Column), erected in 1638 to celebrate the city surviving Swedish occupation during the Thirty Years' War." },
          { time: '9:10 AM', title: "St. Peter's Church", description: "Munich's oldest parish church, first documented around 1181. Its tower (\"Alter Peter\") is a 306-step climb rewarded with the best rooftop panorama over the old town." },
          { time: '9:25 AM', title: 'Viktualienmarkt', description: "A daily food market since 1807, when Munich's old grain market outgrew its space on Marienplatz. Permanent stalls today sell produce, flowers, and Bavarian specialties around a beer garden." },
          { time: '9:40 AM', title: 'Ohel Jakob Synagogue', description: "The main synagogue of Munich's Jewish community, dedicated in 2006 as part of the Jewish Center Munich. Its cube-shaped travertine base topped by a glass structure evokes the tent-like Tabernacle of the Israelites' desert wanderings." },
          { time: '9:55 AM', title: 'Asam Church', description: "Not a commission -- the Asam brothers built this as their own private church next to their house (1733-46). Tiny footprint packed with extravagant Bavarian Rococo decoration. Free entry." },
          { time: '10:10 AM', title: 'Kaufingerstrasse', description: "Munich's busiest shopping street, part of the pedestrian zone linking Marienplatz to Karlsplatz -- the same route medieval merchants used entering the city from the west." },
          { time: '10:20 AM', title: "St. Michael's Church", description: 'The largest Renaissance church north of the Alps, built 1583-97 for the Jesuit order. Its crypt holds the remains of Bavarian King Ludwig II.' },
          { time: '10:30 AM', title: 'Frauenkirche', description: 'Munich\'s late-Gothic cathedral, completed 1488. Look for the "Devil\'s Footprint" mark just inside the entrance.' },
        ],
        tips: [
      ...
      },
      {
        ...
        events: [
          { time: '10:45 AM', title: 'Marienhof', description: 'A quiet green square just north of the New Town Hall, largely rebuilt after WWII bombing destroyed the buildings that once stood here -- long eyed for development but kept open as a rare patch of grass in the old town.' },
          { time: '10:55 AM', title: 'Dallmayr Delicatessen', description: "Munich's legendary gourmet grocer since 1700, famous for its elaborate window displays and coffee roasting -- long a favorite supplier to the Bavarian royal court." },
          { time: '11:05 AM', title: 'Alter Hof', description: "The original moated castle of the Wittelsbach dukes, built around 1255 as Munich's first royal residence before the family moved to the larger Residenz nearby." },
          { time: '11:15 AM', title: 'Platzl Square', description: 'A small historic square whose name simply means "little place," long associated with the beer hall culture centered on the Hofbräuhaus at its edge.' },
          { time: '11:20 AM', title: 'Hofbräuhaus', description: "Munich's most famous beer hall, founded as the royal Bavarian court brewery in 1589 and opened to the public in 1828. Its vaulted hall has hosted everyone from Mozart to Lenin." },
        ],
        tips: [
      ...
      },
      {
        ...
        events: [
          { time: '11:35 AM', title: 'Maximilianstrasse', description: "One of Munich's four royal avenues, laid out under King Maximilian II in the 1850s in an eclectic style blending Gothic, Renaissance, and English influences -- today lined with high-end boutiques and the National Theater." },
          { time: '11:45 AM', title: 'Max-Joseph-Platz', description: 'The stately square fronting the Residenz palace and the Bavarian National Theater, named for King Maximilian I Joseph, whose statue anchors the square.' },
          { time: '11:55 AM', title: 'Viscardigasse', description: 'A narrow side alley nicknamed "Dodger\'s Alley," used by Munich residents during the Nazi era to detour around the Feldherrnhalle memorial on Odeonsplatz and avoid the mandatory Hitler salute required there.' },
          { time: '12:00 PM', title: 'Odeonsplatz', description: "Anchored by the Feldherrnhalle, an 1844 monument to Bavarian military leaders modeled on Florence's Loggia dei Lanzi -- also the site of the failed 1923 Beer Hall Putsch's violent climax." },
          { time: '12:10 PM', title: 'Brienner Strasse', description: "Another of Munich's grand 19th-century boulevards, running from Odeonsplatz toward Königsplatz." },
          { time: '12:20 PM', title: 'Hofgarten', description: 'A formal Italian Renaissance-style garden laid out in 1613-17 for the Wittelsbach rulers behind the Residenz, its central pavilion topped by a gilded figure of Bavaria. Walk ends here.' },
        ],
        tips: [
    ...
    activities: [
      {
        ...
        events: [
          ...
          { time: '9:30 AM', title: 'Reichstag', description: "Home to the German Bundestag since 1999, this 1894 building survived a devastating 1933 fire, WWII bombing, and decades divided by the Berlin Wall before Norman Foster's glass dome crowned its post-reunification restoration." },
          { time: '9:40 AM', title: 'Memorial to Politicians Who Opposed Hitler', description: "A row of cast-iron plaques along the Reichstag's northern edge honors the 96 Reichstag members murdered by the Nazi regime for their opposition, each engraved with a name, party, and date of death." },
          { time: '9:45 AM', title: 'Berlin Wall Victims Memorial', description: 'White crosses along the Spree riverbank commemorate those killed attempting to cross the death strip that ran directly behind the Reichstag from 1961 to 1989.' },
          { time: '9:55 AM', title: 'Brandenburg Gate', description: 'Completed in 1791 as a Prussian city gate topped by the goddess Quadriga, this neoclassical landmark became the enduring symbol of a divided and later reunified Berlin.' },
          { time: '10:05 AM', title: 'Tiergarten', description: "Once royal hunting grounds, this sprawling 520-acre park now forms Berlin's green lung, stretching west from the Brandenburg Gate." },
          { time: '10:15 AM', title: 'Pariser Platz', description: "Rebuilt after being leveled in WWII and left as a windswept no-man's-land during the Cold War, this stately square in front of the Gate is again ringed by embassies and the historic Hotel Adlon." },
          { time: '10:25 AM', title: 'Memorial to the Murdered Jews of Europe', description: "Dedicated in 2005, Peter Eisenman's field of 2,711 concrete slabs of varying height creates a deliberately disorienting space remembering the six million Jewish victims of the Holocaust." },
          { time: '10:40 AM', title: "Site of Hitler's Bunker", description: 'An unmarked parking lot on Gertrud-Kolmar-Strasse sits atop the bunker where Hitler married Eva Braun and took his own life on April 30, 1945; only a small information placard marks the spot.' },
        ],
        tips: [
      ...
      },
      {
        ...
        linkLabel: 'Get directions: Phase 2 →',
        events: [
          { time: '10:50 AM', title: 'Wilhelmstrasse', description: "Once the address of the Reich Chancellery and the nerve center of Nazi Germany's government, this street is now lined with modern apartments and ministries." },
          { time: '11:00 AM', title: 'Unter den Linden', description: "Berlin's grand central boulevard, planted with linden trees since the 17th century, has linked the Brandenburg Gate to the royal palace for over 300 years." },
          { time: '11:05 AM', title: 'Brandenburger Tor S-Bahn Station', description: "This transit hub sits atop one of the city's most storied crossing points, a short walk from where East and West Berlin were once sealed off from each other." },
          { time: '11:10 AM', title: 'Russian Embassy', description: 'The Soviet Union built this monumental embassy, the largest diplomatic mission in Cold War-era Berlin, on Unter den Linden in the early 1950s as a statement of power.' },
          { time: '11:20 AM', title: 'Friedrichstrasse', description: "Historically Berlin's most fashionable shopping and theater street, this bustling crossroads has been rebuilt and reinvented many times over." },
          { time: '11:25 AM', title: 'Bebelplatz', description: 'On the night of May 10, 1933, Nazi students burned some 20,000 "un-German" books in this square; a glass floor panel now reveals a haunting installation of empty white bookshelves below.' },
          { time: '11:35 AM', title: 'Neue Wache', description: "Karl Friedrich Schinkel's 1818 royal guardhouse now serves as Germany's central memorial to victims of war and tyranny, sheltering an enlarged cast of Käthe Kollwitz's \"Mother with Her Dead Son\" beneath an open oculus." },
          { time: '11:45 AM', title: 'Museum Island & Humboldt Forum', description: "The reconstructed Berlin Palace, once home to Prussian kings, now houses the Humboldt Forum's collections of non-European art and culture, completed in 2020." },
        ],
        tips: [
      ...
      },
      {
        ...
        linkLabel: 'Get directions: Phase 3 →',
        events: [
          { time: '11:55 AM', title: 'Museum Island Sights', description: 'This UNESCO World Heritage complex gathers five major museums, including the Pergamon and Altes Museum, alongside the domed Berlin Cathedral.' },
          { time: '12:05 PM', title: 'Spree River', description: "Berlin grew up along this modest river, whose bridges and canals still shape the city's geography much as they did when medieval Cölln and Berlin first faced each other across its banks." },
          { time: '12:10 PM', title: 'Marx & Engels Statues', description: "Erected in 1986 in the GDR-era Marx-Engels-Forum, these bronze figures of communism's founding theorists remain a popular, if ironic, photo stop today." },
          { time: '12:15 PM', title: 'Karl-Liebknecht-Strasse & Plattenbau', description: 'Named for a socialist leader killed in 1919, this broad avenue is flanked by prefabricated "Plattenbau" apartment blocks characteristic of East German urban planning from the 1960s-80s.' },
          { time: '12:20 PM', title: "Martin Luther Statue & St. Mary's Church", description: "Berlin's second-oldest church, dating to around 1270, stands watch over an 1895 statue of the Reformation leader." },
          { time: '12:25 PM', title: 'TV Tower', description: 'Built by the East German government in 1969 to showcase socialist engineering, this 368-meter spire remains the tallest structure in Germany, with an observation deck and revolving restaurant.' },
          { time: '12:30 PM', title: 'Alexanderplatz', description: "Named for Russian Tsar Alexander I after his 1805 visit, this vast plaza has long served as Berlin's commercial hub, still anchored by its iconic World Time Clock. Walk ends here." },
        ],
        tips: [
