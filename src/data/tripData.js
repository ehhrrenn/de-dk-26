    ...
    activities: [
      {
        ...
        category: 'Travel',
        cost: null,
        summary: 'From Home in Copenhagen to CPH (Kastrup) for the SK 935 return flight.',
        ...
        linkLabel: 'Get directions to the airport →',
        events: [
          { time: '~10:30 AM', title: 'Leave the Copenhagen stay', description: 'Head to CPH Airport, Departure Terminal 3, ahead of the 12:45 PM SK 935 departure.' },
        ],
        tips: [],
      },
      {
